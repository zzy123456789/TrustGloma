 ...
 *
 */
public class SpectralTrustUser extends Cluster {
	 ...
	 *************** 
	 */
	public SpectralTrustUser() throws IOException, Exception {
		super();
	...
	public void RatioCut() {
		...
		usersSpectral = new double[ClusterDataInfo.userNum][k1];
		Eig[] tempEig = new Eig[ClusterDataInfo.userNum];
		...
		for(int i = 0 ; i < k1; i++ ){
			for(int j = 0; j < ClusterDataInfo.userNum; j++){				
	...
	public void NCut() {
		...
		double[][] normalD = new double[ClusterDataInfo.userNum][ClusterDataInfo.userNum];
		double[][] normalL = new double[ClusterDataInfo.userNum][ClusterDataInfo.userNum];
				
		usersSpectral = new double[ClusterDataInfo.userNum][k1];
		Eig[] tempEig = new Eig[ClusterDataInfo.userNum];
		
		//1.get new D, L
		normalD = ClusterDataInfo.getDegreeMatrix(ClusterDataInfo.userNum, ClusterDataInfo.userTotalDegree);
	...
	public static void test() throws Exception {
		...
		SpectralTrustUser tempSpectral = new SpectralTrustUser();
